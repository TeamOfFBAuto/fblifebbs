...
#import "ZkingAlert.h"
@interface commentViewController : SNViewController<UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate,EGORefreshTableHeaderDelegate,UIActionSheetDelegate,UIScrollViewDelegate,downloaddelegate>{
