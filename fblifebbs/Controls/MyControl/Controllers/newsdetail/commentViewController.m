...
//    }
    ...
    view_pinglun=[[UIView alloc]initWithFrame:CGRectMake(0,DEVICE_HEIGHT - 64 - 41, 320, 41)];
...
//    }
    ...
    tab_pinglunliebiao=[[UITableView alloc]initWithFrame:CGRectMake(0, 0, DEVICE_WIDTH, DEVICE_HEIGHT - 64 - 52)];
...
-(void)prepairCommentTiao{
    ...
    inputV=[[CustomInputView alloc]initWithFrame:CGRectMake(0,DEVICE_HEIGHT - 64 - 41, 320, 41)];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UILabel *label_time=[[UILabel alloc]initWithFrame:CGRectMake(DEVICE_WIDTH - 80, 7, 80 - 15, 15)];
    label_time.textAlignment=NSTextAlignmentLeft;
    label_time.backgroundColor=[UIColor redColor];
...
-(UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    if (section==0) {
        ...
        if ([array_name count]!=0) {
            ...
            [otherheaderview addSubview:aview1];
            label_time.frame=CGRectMake(DEVICE_WIDTH - 100 - 10, 10, 100, 20);
...
-(void)faceview{
    ...
    if (isjianpan) {
        ...
        aview.frame=CGRectMake(0, -162-55, DEVICE_WIDTH, DEVICE_HEIGHT);
...
//    }
    ...
    faceScrollView.frame = CGRectMake(0, DEVICE_HEIGHT-180-44-55, self.view.frame.size.width, 221);
